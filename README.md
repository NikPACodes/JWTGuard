...
- [JWTGuard — управляемая JWT-аутентификация на Django, PyJWT и Redis](#-jwtguard--управляемая-jwt-аутентификация-на-django-pyjwt-и-redis)
  ...
  - [Политика репозитория](#-политика-репозитория)
...
[BRUNO](./docs/BRUNO.md) ── Коллекция Bruno для воспроизведения Auth, Content и Security сценариев.

---

### 🏛️ Политика репозитория
ℹ️ Этот репозиторий является общедоступным образовательным/справочным проектом только для чтения.

⚠️ Запросы на слияние (pull requests) не принимаются. Сообщения об ошибках (issues) принимаются только для воспроизводимых ошибок.  
⚠️ Запросы на добавление новых функций, предложения по рефакторингу, обсуждения архитектуры, вопросы поддержки и запросы на адаптацию не принимаются.  
⚠️ Будущие изменения ограничиваются исправлением ошибок, корректировкой документации и исправлениями, связанными с безопасностью, если это необходимо.

Подробности см. в [CONTRIBUTING](./CONTRIBUTING.md) и [SECURITY](./SECURITY.md).
