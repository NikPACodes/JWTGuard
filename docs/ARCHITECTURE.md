# 🏗️ JWTGuard — Архитектура проекта

## 🎯 Назначение документа

Этот документ описывает архитектуру проекта JWTGuard: основные модули, границы ответственности, 
ключевые технические решения и причины выбора текущего подхода.

---

## Оглавление
- [JWTGuard — Архитектура проекта](#-jwtguard--архитектура-проекта)
...
JWTGuard реализует управляемую JWT-аутентификацию на базе стека:
- _Django_
...
## 📌 Итог
JWTGuard — это не простой stateless JWT-пример.
